...
export async function PUT(request: Request, { params }: RouteContext) {
  ...
  try {
    ...
    /*
     * Answering is never metered, on any plan. The allowance was spent when the
     * session was created, so a student can always finish what they started —
     * across a refresh, a reconnect, a second device, or a day boundary.
     */
